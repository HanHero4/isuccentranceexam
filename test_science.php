...
echo ' alert("Timer Duration: 25 Minutes")';  //showing an alert box.
echo '</script>';

$sql = "SELECT * FROM test_science;";
...
<body onload="f1()" style="background-color: white;">
    ...
    <section style="background-color: white;">
        <div>
            ...
            <div class="exam-test">
                <h1 style="padding-top: 10px; text-align:center;">SCIENCE TEST</h1>
                ...
                <form action="test_science.php" method="POST">
                    <?php $score_science = 0; ?>
...
<div class="inform">
    ...
    if ($score_science == 0) {
        ...
        $query = "INSERT INTO score_science(science) VALUES ($score_science)";
