...
if ($ans1 && $ans2) {
    header("Location: test_filipino.php");
}
...
<body onload="f1()">
    ...
    <section style="background-color: white;">
        <div>
            ...
            <div class="exam-test">
                <h1 style="padding-top: 10px; text-align:center;">ENGLISH TEST</h1>
                ...
                <form action="test_english.php" method="POST">
                    <?php $score_english = 0; ?>
...
<?php
    if ($score_english == 0) {
        ...
        $query = "INSERT INTO score_english(english) VALUES ($score_english)";
