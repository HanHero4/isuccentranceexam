            ...
            <div class="col-rt-12">
                ...
                <div class="slider">
                    <ul class="slider__list">
                        <li class="slider__slide"><img src="gallery1.jpg" /></li>
                        <li class="slider__slide"><img src="gallery2.jpg" /></li>
                        <li class="slider__slide"><img src="gallery3.jpg" /></li>
                        <li class="slider__slide"><img src="gallery4.jpg" /></li>
                    </ul>
                </div>
